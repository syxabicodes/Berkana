      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 pt-20">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Five Sectors.{" "}
            <span className="gradient-text">Infinite Impact.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {impactAreas.map((area, i) => (
            ...
            >
              ...
              <div className="relative glass rounded-2xl p-8 h-full hover:border-white/10 transition-all">
                <div
                ...
                >
                  <div className="pt-4 border-t border-white/10">
                    ...
                    <p className="text-sm text-slate-300">{area.stats}</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
